...
Datastore.prototype.loadDatabaseAsync = promisefy(Datastore, 'loadDatabase');
Datastore.prototype.findAsync = promisefy(Datastore, 'find');
Datastore.prototype.findOneAsync = promisefy(Datastore, 'findOne');
Datastore.prototype.insertAsync = promisefy(Datastore, 'insert');
Datastore.prototype.updateAsync = promisefy(Datastore, 'update');
Datastore.prototype.upsertAsync = promisefy(Datastore, 'upsert');
Datastore.prototype.removeAsync = promisefy(Datastore, 'remove');
